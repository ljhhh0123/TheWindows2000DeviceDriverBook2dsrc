// Testor for Chapter 8 Parallel Port Driver
...
int main() {
	...
	printf("Beginning test of Parallel Port Driver (CH8)...\n");
	...
	printf("Succeeded in obtaining handle to PPT1 device.\n");
	...
	printf("Attempting to close device PPT1...\n");
	status =
		CloseHandle(hDevice);
	if (!status) {
