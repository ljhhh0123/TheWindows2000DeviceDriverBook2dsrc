...
# ADD LINK32 int64.lib ntoskrnl.lib hal.lib /nologo /base:"0x10000" /entry:"DriverEntry" /pdb:none /machine:I386 /nodefaultlib /out:"Release\Minimal.SYS" /libpath:"D:\NTDDK\libfre\i386" -driver -subsystem:NATIVE,4.00
...
# ADD LINK32 int64.lib ntoskrnl.lib hal.lib /nologo /base:"0x10000" /entry:"DriverEntry" /incremental:no /map /debug /machine:I386 /nodefaultlib /out:"Debug\Minimal.SYS" /libpath:"D:\NTDDK\libchk\i386" -driver -subsystem:NATIVE,4.00
# Begin Special Build Tool
TargetPath=.\Debug\Minimal.SYS
SOURCE="$(InputPath)"
